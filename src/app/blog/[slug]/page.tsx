...
const detailedPosts: Record<string, PostDetail> = {
  'secrets-of-24-hour-dal': {
    ...
    introduction: 'At the heart of the Grand Pavilion menu sits our most prized creation: Dal Suprabath. This simple dish of black lentils requires a tedious 24-hour slow-cooking ritual that preserves legacy preparation styles dating back centuries.',
    bodyParagraphs: [
  ...
  'saffron-sourcing-in-kashmir': {
    ...
    author: 'Chef Raghavan Iyer',
    introduction: 'Saffron, known as the red gold of Kashmir, is the soul of several signature dishes at the Grand Pavilion. Let us explore the rigorous harvesting journey this delicate spice undertakes before gracing our recipes.',
    bodyParagraphs: [
      ...
      "We source our saffron strands whole to prevent adulteration. At India's Grand Pavilion, we use this red gold to poach our Saffron Butter Lobster tails, encapsulate our Cardamom Mango Kulfi, and flavor our house Rose Petal Cardamom Lassi, ensuring that each bite carries the authentic, sun-dried essence of Kashmir."
    ]
  },
  'art-of-tandoor-cooking': {
    ...
    author: 'Chef Raghavan Iyer',
    introduction: 'The tandoor, a cylindrical clay oven, is a pillar of traditional Indian cooking. At Grand Pavilion, we combine this centuries-old clay-baking heritage with modern gastronomy to achieve absolute perfection.',
    bodyParagraphs: [
        ...
        >
          ...
          <div className="border-t border-luxury-gold/15 pt-8 flex items-center justify-between max-w-3xl mx-auto">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-serif font-bold text-sm text-white">India's Grand Pavilion</h4>
